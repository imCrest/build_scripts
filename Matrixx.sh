...
. build/envsetup.sh && \
lunch matrixx_larry-userdebug && \
make installclean && \
m bacon && \
mv device/oneplus/larry/matrixx_larry.mk device/oneplus/larry/vanilla.txt && \
...
mv device/oneplus/larry/gapps.txt device/oneplus/larry/matrixx_larry.mk && \
make installclean && \
m bacon && \
mv device/oneplus/larry/matrixx_larry.mk device/oneplus/larry/gapps.txt && \

echo "===== Handling Gapps Output ====="
mv out/target/product/larry out/target/product/gapps && \

# --- Restore Vanilla ---
mv device/oneplus/larry/vanilla.txt device/oneplus/larry/matrixx_larry.mk && \

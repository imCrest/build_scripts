...
RELEASE_NOTES="PLEASE ANYONE ON THE LATEST 1600 FIRMWARE OR 1301 FIRMWARE, DO NOT FLASH ANY CUSTOM ROM, IT CAUSES HARD BRICKS STILL, MANY PEOPLE LIKE ME HAVE ENCOUNTERED ISSUES LIKE HARD BRICKS.

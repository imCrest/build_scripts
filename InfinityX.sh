...
git clone https://github.com/sahusujall/android_device_oneplus_sm6375-common -b lineage-22.2 device/oneplus/sm6375-common && \

# --- Clone Vendor Tree ---
git clone https://github.com/sahusujall/proprietary_vendor_oneplus_larry -b lineage-23.0 vendor/oneplus/larry && \

# --- Clone Common Vendor Tree ---
git clone https://github.com/sahusujall/proprietary_vendor_oneplus_sm6375-common -b lineage-23.0 vendor/oneplus/sm6375-common && \

# --- Clone Kernel Tree ---
git clone https://github.com/sahusujall/android_kernel_oneplus_sm6375 -b lineage-23.0 kernel/oneplus/sm6375 && \
